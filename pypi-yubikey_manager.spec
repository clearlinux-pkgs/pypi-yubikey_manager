...
Source0  : https://files.pythonhosted.org/packages/08/56/66cfa3149a54ee55a27de742a0a46944df76acf0b9d2fc8377e43e92167a/yubikey_manager-5.7.2.tar.gz
...
%prep
%setup -q -n yubikey_manager-5.7.2
cd %{_builddir}/yubikey_manager-5.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749508817
